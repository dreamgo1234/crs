  ...
  <section class="content">
    <div class="columns">
      <main class="main"><b style="color:#0d0d57; text-align: center; font-weight: bold"><p> <b>  <?php echo strtoupper($f['govtlocal'])?>  </b><br/>  
                 <?php echo strtoupper($f['govten'])?></p>
    ...
    <?php echo strtoupper($f['hospitalnamelocal'])?><br/> 
     <?php echo strtoupper($f['hospitalname'])?>  <br/> 
        ...
        <p> <b style="color:#b31302;font-size: 13px;margin-top:3px;" > 
    ...
    <br>
      ...
      <aside class="sidebar-second" style="padding:20px;padding-right:80px;">
       <b style="font-size: 12px;padding:-10px;font-weight: lighter;text-align: right;" >
        ...
        <p>  <?php echo strtoupper($f['namelocal'])?>  / NAME : <?php echo strtoupper($b['name']) ; ?></p>
                      ...
                      <p> <?php echo strtoupper($f['doblocal'])?>  | DATE OF DEATH: <br>
                 <?php echo $b['dob'] ; ?><br>
                  <?php if($b['dobwords'] == "") { echo "&nbsp;"; } else {
                  echo strtoupper($b['dobwords']); }?>  </p>
               <p> <?php echo strtoupper($f['age'])?>  | AGE OF DECEASED: 
                 <br>
            ...
            <p style="margin-top:-3px;"> <?php echo strtoupper($f['mnamelocal'])?>  / NAME OF MOTHER:  <br/> <?php echo strtoupper($b['mname'] ); ?> 
        </p>
             ...
             &nbsp; 
             <?php } ?>
                          <p style="height:57px">   <?php echo strtoupper($f['birthaddresslocal'])?> / ADDRESS OF DECEASED AT THE TIME OF DEATH :<br/>  <?php echo strtoupper($b['birthaddress'] ); ?> </p>
                ...
                <br>
                   <p >UPDATED ON :<br/> <?php echo strtoupper($b['updatedate'] ); ?> </p>   
                 <img src="http://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data=<?php echo $wurl ; ?>https://crsprint.online/web%2Findex.php%2Fauth%2FdeathCertificate%2Fview%2FB%2FbWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php%3Fid%3D<?php echo $_GET['id'];?>%26cont%3DAnjsjdn&amp;qzone=1&amp;margin=0&amp;size=400x400&amp;ecc=L" width="65px;" height="65px" />
             
            </td>
            <td>
                <div style="margin-top: -75px" width="140%"  >
      ...
      &nbsp;
           ...
           <p> <?php echo strtoupper($f['poblocal'])?> / PLACE OF DEATH :
            <br>
           <?php echo  strtoupper($b['placeofbirth']) ; ?>
          <br>
             &nbsp; <br>
          </p>
          <p>  <?php echo strtoupper($f['hwnamee'])?> | NAME OF HUSBAND / WIFE: 
                 <br>
                 <?php echo  strtoupper($b['hwname']) ; ?>
                  <br> 
                  </p>
              <p> <?php echo strtoupper($f['aadharlocal'])?>  | HUSBAND / WIFE AADHAAR NO: 
                 <br>
            ...
            <p style="margin-top:-3px;"><?php echo strtoupper($f['fnamelocal'])?>  / NAME OF FATHER :<br/>  <?php echo strtoupper($b['fname'] ); ?> </p>
          ...
          <p style="height:57px"><?php echo strtoupper($f['permanentaddresslocal'])?> / PERMANENT ADDRESS OF DECEASED: <br> <?php echo strtoupper($b['permanentaddress']) ; ?></p>
        ...
        <center>
            ...
            <img alt=""
                                                          ...
                                                          style="width:260px;height:25px"></center>

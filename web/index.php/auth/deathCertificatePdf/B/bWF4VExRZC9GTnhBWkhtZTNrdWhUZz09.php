...
$searchid = $_GET['id'] ;
$a = mysqli_query($conn,"SELECT * FROM dmanual Where id='".$searchid."'");
$b = mysqli_fetch_array($a);
$hsptl = $b['hospital'];
mysqli_set_charset($conn,"utf8");
$c = mysqli_query($conn,"SELECT * FROM dportal Where hospital='$hsptl'");
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="text-line-height normal-text" align="center"
                                                        ...
                                                        <span lang="hi">
                                                         <?php echo strtoupper($f['govtlocal'])?>                                                 </span>
                                                        <br>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="center" valign="top" class="lable-text">
                                                        ...
                                                        <span lang="hi">
                                                            <?php echo strtoupper($f['deptlocal'])?>                                                      </span> <br>
                                                             <?php echo strtoupper($f['dept'])?>                                                   </td>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="center" valign="top"
                                                        ...
                                                        <span lang="hi">
                                                                  <?php echo strtoupper($f['hospitalnamelocal'])?> </span><br>    <?php echo strtoupper($f['hospitalname'])?>                                                     </td>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td colspan="3" align="justify" valign="top"
                                                        ...
                                                        <span lang="hi">
                                                                        <?php echo strtoupper($f['line2local'])?>                                          </span>
                                                        <!--// Added by Naveen 30-04-2016 at 11:02 am for maintaining the history of registration unit (end)-->
                                                        ...
                                                        <table width="100%">
                                                          <tr>
                                                            <td width="40%" align="left"
                                                              ...
                                                              <span lang='hi'>
                                                                      <?php echo strtoupper($b['name']) ; ?>                                                         </span>
                                                            </td>
                                                            <td width="20%"></td>
                                                            <td width="40%" class="text-line-height normal-text"
                                                              ...
                                                              <span lang="hi">
                                                                          <?php echo strtoupper($b['gender']) ; ?>                                                    </span>
                                                         ...
                                                         <tr>
                                                            <td align="left" class="text-line-height normal-text"
                                                              ...
                                                              <?php echo $b['dob'] ; ?>
                                                               <br>
                                                                    <?php echo strtoupper($b['dobwords']); ?>                                                      </td>
                                                            <td></td>
                                                            <td class="text-line-height normal-text"
                                                              ...
                                                              <span lang="hi">
                                                                ...
                                                                <!--IF ADDRESS OUT OF INDIA-->
                                                                       <?php echo strtoupper($b['placeofbirth']) ; ?>                                                        </span>
                                                            </td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            <td align="left" class="text-line-height normal-text"
                                                              ...
                                                              <span lang="hi">    <?php echo strtoupper($f['age']) ; ?>  </span>/
                                                               AGE OF DECEASED :
                                                              <br>
                                                            
                                                              <?php echo strtoupper($b['agee']) ; ?>
                                                                                                                          </td>
                                                            <td></td>
                                                            <td class="text-line-height normal-text"
                                                              style="padding-top: 10px; text-align: left">
                                                              ...
                                                              <span lang="hi">
                                                               <?php echo strtoupper($f['hwnamee']) ; ?> </span>/
                                                              ...
                                                              <span lang="hi">
                                                                ...
                                                                <!--IF ADDRESS OUT OF INDIA-->
                                                                         <?php echo strtoupper($b['hwname']) ; ?>                                                     </span>
                                                            </td>
                                                          </tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td class="text-line-height normal-text"
                                                              ...
                                                              <span lang="hi">
<?php if($b['hwaadhar'] != "") { ?>
             XXXXXXXX<?php echo substr($b['hwaadhar'], -4); ?></p>
             <?php } else { ?>
             &nbsp; 
             <?php } ?>
                                                          ...
                                                          <tr>
                                                            <td align="left" class="text-line-height normal-text"
                                                              ...
                                                              Name of Mother: <br>
                                                              <span lang='hi'>
                                                                          <?php echo strtoupper($b['mname']) ; ?>                                                    </span>
                                                              <!-- ---------------------------------------------------------------------------------  -->
                                                            ...
                                                            <td align="left" class="text-line-height normal-text"
                                                              ...
                                                              Name of Father : <br>
                                                              <span lang='hi'>
                                                                  <?php echo strtoupper($b['fname']) ; ?>                                                            </span>
                                                              <!-- ---------------------------------------------------------------------------------  -->
             ...
             <?php } ?> 
                                                          ...
                                                          <tr>
                                                            ...
                                                            <?php echo strtoupper($f['birthaddresslocal'])?>  </span> /
                                                              ...
                                                              Address of the deceased at the time of death of the death:
                                                              ...
                                                              <span lang="hi">
                                                                        <?php echo strtoupper($b['birthaddress'] ); ?>                                                      </span>
                                                ...
                                                <?php echo strtoupper($f['permanentaddresslocal'])?> </span> /
                                                              ...
                                                              <span lang="hi">
                                                                        <?php echo strtoupper($b['permanentaddress'] ); ?>                                                      </span>
                                                          ...
                                                          <tr>
                                                            <td align="left" class="text-line-height normal-text"
                                                              style="padding-top: 10px" valign="top">
                                                              <span lang="hi"> <?php echo strtoupper($f['regnolocal'])?>
                                                                </span> /
                                                              Registration Number: <br>
                                                                     <?php echo strtoupper($b['regno'] ); ?>                                                     </td>
                                                            <td></td>
                                                            <td class="text-line-height normal-text"
                                                              ...
                                                              Date of Registration: <br>
                                                                       ...
                                                                       <?php echo strtoupper($b['dateofregister'] ); ?>                                                   </td>
                                                          </tr>
                                                          <tr>
                                                            <td align="left" class="text-line-height normal-text"
...
<?php echo strtoupper($b['dateofissue'] ); ?>
                                                            ...
                                                            <td class="text-line-height normal-text"
                                                              ...
                                                              <div style="float: left;">
                                                                <div
                                                                  ...
                                                                  <span lang="hi"> <?php echo strtoupper($f['registrarlocal'])?><br></span>  <?php echo strtoupper($f['registrar'])?>                                                                    <!--Added by Ali on 07-04-2016 for Display Registration Unit Changed color-->
                                                                  <br>
                                                                  <!--// Added by Naveen 30-04-2016 at 11:02 am for maintaining the history of registration unit (start)-->
                                                          ...
                                                          <tr>
                                                            <td class="text-line-height normal-text"
                                                              ...
                                                              <br>
                                                                  <?php echo strtoupper($b['updatedate'] ); ?>                                                        </td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                              <img src="https://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data=https://crsorgigoovi.in/web%2Findex.php%2Fauth%2FdeathCertificate%2Fview%2FB%2FbWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php%3Fid%3D%26cont%3DAnjsjdn&amp;qzone=1&amp;margin=0&amp;size=400x400&amp;ecc=L" style="width: 80px;  height: 80px;">
                                                            </td>
                                                            <!--// Added by Anupam 02-05-2016 at 5:30 PM for Qrcode integration (end)-->
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="center" valign="top"><img alt=""
                                                          src="https://www.scandit.com/wp-content/themes/scandit/barcode-generator.php?symbology=code128&value=623eada587b6b980275&size=400&ec=L"
                            ...
                            <tr>
                              ...
                              <td class="btn">
                                <a class="btn" target="_blank"
                                  href="https://crsorgigovi.online/web/index.php/auth/deathCertificatePdf/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php/type/print.php?id=<?php echo $b['id'] ;?>">Print</a>
                              </td>
                              <td>&nbsp;</td>
                              <td class="btn">

...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">View Death Certificate</h1>
      </div><!-- /.col -->
			...
			<div class="col-md-12">
				...
				<div class="card card-default">
				    ...
				    <div class="card-body row">
							...
							<div class="form-group col-md-6">
								<label for="name" style="font-weight: 500;">मृतक का नाम / Full Name: <strong><?php echo $data['name'] ?></strong></label>
							</div>
							...
							<div class="form-group col-md-6">
								<label for="date_of_death" style="font-weight: 500;">मृत्यु तिथि / Date of death: <strong><?php echo $data['dob'] ?></strong></label>
							</div>

							<div class="form-group col-md-6">
								<label for="dob_word" style="font-weight: 500;">मृत्यु तिथि / Date of death(IN WORD): <strong><?php echo $data['dobwords'] ?></strong></label>
							</div>

							<div class="form-group col-md-6">
								<label for="death_place" style="font-weight: 500;">मृत्यु स्थान / Place of Death: <strong><?php echo $data['placeofbirth'] ?></strong></label>
							</div>

							<div class="form-group col-md-6">
								<label for="hus_name" style="font-weight: 500;">पति / पत्नी का नाम / NAME OF HUSBAND / WIFE: <strong><?php echo $data['hwname'] ?></strong></label>
							</div>

							<div class="form-group col-md-6">
								<label for="hus_aadhar" style="font-weight: 500;">पति / पत्नी का आधार संख्या / HUSBAND / WIFE AADHAAR NO: <strong><?php echo $data['hwaadhar'] ?></strong></label>
							</div>
							...
							<div class="form-group col-md-6">
								<label for="death_address" style="font-weight: 500;">मृत्यु के समय पता / Address at time of death: <strong><?php echo $data['birthaddress'] ?></strong></label>
							</div>
							...
							<div class="form-group col-md-6">
								...
								<a type="button" href="web/index.php/auth/deathCertificate/view/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php?id=<?php echo $data['id'] ?>&cont=Anjsjdn" class="btn btn-dark btn-sm" style="width: 190px;">Download Certificate</a>
							</div>

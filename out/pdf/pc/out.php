...
<b style="color:#0d0d57; text-align: center; font-weight: bold"><p> <b> बिहार सरकार </b><br/>  
    ...
    गुरु गोविंद सिंह पटना अस्पताल पटना  सिटी <br/> 
       GURU GOVIND SINGH PATNA HOSPITAL PATNA CITY <br/> 
         </p>
    ...
    <br>
        ...
        (ISSUED UNDER SECTION 12/17 OF THE REGISTRATION OF BIRTHS & DEATHS ACT, 1969 AND RULE 8/13 OF THE BIHAR REGISTRATION OF BIRTHS & DEATHS RULES 1999)
            ...
            <p> यह प्रमाणित  किया जाता है निम्नलिखित सुचना जन्म के मूल  साभिलेख से ली  गई है जो की गुरु गोविन्द सिंह पटना हॉस्पिटल पटना सिटी  तहसील पटना सदर  जिला पटना राज्य / संघ प्रदेश बिहार , भारत के रजिस्टर में उल्लिखित है ।   <br>THIS IS TO CERTIFY THAT THE FOLLOWING INFORMATION HAS BEEN TAKEN FROM THE ORIGINAL RECORD OF BIRTH WHICH IS THE REGISTER
FOR GURU GOVIND SINGH PATNA HOSPITAL PATNA CITY OF TAHSIL/BLOCK PATNA SADAR OF DISTRICT PATNA OF STATE/UNION TERRITORY
                BIHAR, INDIA.</p>
        </div>
        ...
        <p>नाम/ NAME : <?php echo strtoupper($b['name']) ; ?></p>
          ...
          <div style="text-align: center; margin-top:20px;">
                <img src="4.PNG" / width="60px; height:50px"><br />
